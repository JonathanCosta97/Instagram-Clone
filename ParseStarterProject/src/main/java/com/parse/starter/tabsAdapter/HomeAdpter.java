...
public class HomeAdpter extends ArrayAdapter<ParseObject> {

    private Context context;
    private ArrayList<ParseObject> postagens;

    public HomeAdpter(Context c, ArrayList<ParseObject> objects) {
        super(c, 0, objects);
        this.context = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        */
        ...
        if( postagens.size() > 0 ){
            ...
            ImageView imagemPostagem = (ImageView) view.findViewById(R.id.imgPostagem);
